...
namespace DanCon
{
    public class AttackScript : MonoBehaviour
    {
        ...
        { //calls the methods below 
            ...
            if (gameObject.CompareTag("PlayerOne") && Input.GetKeyDown(KeyCode.Comma) && isBlocked == false) // changed to delete for testing at home - i don't have a numpad (poor.people.problems)
            {
                if (Time.time > lastAttack + coolDown)
                {
                    UpAttack();
